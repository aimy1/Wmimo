...
class _Translations$meta$es implements Translations$meta$en {
	...
	@override String get launchAtStartupRunAsAdmin => 'Por favor, reinicie Wmimo como administrador';
	...
	@override String get portableModeDisableTips => 'Si necesita salir del modo portátil, cierre [Wmimo] y elimine manualmente la carpeta [portable] en el mismo directorio que [wmimo.exe]';
	...
	@override String get connections => 'Conexiones Activas';
	...
	@override String get requestNeedsUserApproval => '1. Por favor [Permitir] que Wmimo instale extensiones del sistema en [Ajustes del Sistema]-[Privacidad y Seguridad]\n2. [Ajustes del Sistema]-[General]-[Extensiones de Ítems de Inicio]-[Extensión de Red] habilite [wmimoServiceSE]\nreconnecte después de completar';
	@override String get FullDiskAccessPermissionRequired => 'Por favor, habilite el permiso wmimoServiceSE en [Ajustes del Sistema]-[Privacidad y Seguridad]-[Acceso Total al Disco] y vuelva a conectar.';
...
extension on TranslationsEs {
	dynamic _flatMapFunction(String path) {
		return switch (path) {
			...
			'meta.launchAtStartupRunAsAdmin' => 'Por favor, reinicie Wmimo como administrador',
			...
			'meta.portableModeDisableTips' => 'Si necesita salir del modo portátil, cierre [Wmimo] y elimine manualmente la carpeta [portable] en el mismo directorio que [wmimo.exe]',
			...
			'meta.connections' => 'Conexiones Activas',
			...
			'meta.requestNeedsUserApproval' => '1. Por favor [Permitir] que Wmimo instale extensiones del sistema en [Ajustes del Sistema]-[Privacidad y Seguridad]\n2. [Ajustes del Sistema]-[General]-[Extensiones de Ítems de Inicio]-[Extensión de Red] habilite [wmimoServiceSE]\nreconnecte después de completar',
			'meta.FullDiskAccessPermissionRequired' => 'Por favor, habilite el permiso wmimoServiceSE en [Ajustes del Sistema]-[Privacidad y Seguridad]-[Acceso Total al Disco] y vuelva a conectar.',
			'meta.proxy' => 'Proxy',
			'meta.theme' => 'Tema',
			'meta.tvMode' => 'Modo TV',
