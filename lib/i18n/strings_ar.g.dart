...
class _Translations$meta$ar implements Translations$meta$en {
	...
	@override String get launchAtStartupRunAsAdmin => 'يرجى إعادة تشغيل Wmimo كمسؤول';
	...
	@override String get portableModeDisableTips => 'إذا كنت بحاجة إلى الخروج من الوضع المحمول، فيرجى الخروج من [Wmimo] وحذف المجلد [portable] يدويًا في نفس الدليل مثل [wmimo.exe]';
	...
	@override String get requestNeedsUserApproval => '١. يُرجى السماح لـ Wmimo بتثبيت ملحقات النظام من [إعدادات النظام] - [الخصوصية والأمان]. ٢. : [إعدادات النظام] - [عام] - [عناصر تسجيل الدخول والملحقات - ملحقات الشبكة] فعّل [wmimoServiceSE]. أعد الاتصال بعد الانتهاء.';
	@override String get FullDiskAccessPermissionRequired => 'يرجى تمكين إذن wmimoServiceSE في [إعدادات النظام]-[الخصوصية والأمان]-[الوصول الكامل للقرص] وإعادة الاتصال.';
...
extension on TranslationsAr {
	dynamic _flatMapFunction(String path) {
		return switch (path) {
			...
			'meta.launchAtStartupRunAsAdmin' => 'يرجى إعادة تشغيل Wmimo كمسؤول',
			'meta.tunModeRunAsAdmin' => 'يتطلب وضع TUN أذونات مسؤول النظام ، يرجى إعادة تشغيل التطبيق كمسؤول',
			'meta.portableMode' => 'الوضع المحمول',
			'meta.portableModeDisableTips' => 'إذا كنت بحاجة إلى الخروج من الوضع المحمول، فيرجى الخروج من [Wmimo] وحذف المجلد [portable] يدويًا في نفس الدليل مثل [wmimo.exe]',
			...
			'meta.requestNeedsUserApproval' => '١. يُرجى السماح لـ Wmimo بتثبيت ملحقات النظام من [إعدادات النظام] - [الخصوصية والأمان]. ٢. : [إعدادات النظام] - [عام] - [عناصر تسجيل الدخول والملحقات - ملحقات الشبكة] فعّل [wmimoServiceSE]. أعد الاتصال بعد الانتهاء.',
			'meta.FullDiskAccessPermissionRequired' => 'يرجى تمكين إذن wmimoServiceSE في [إعدادات النظام]-[الخصوصية والأمان]-[الوصول الكامل للقرص] وإعادة الاتصال.',
			'meta.proxy' => 'التمثيل',
			'meta.theme' => 'سمة',
