...
import 'package:wmimo/app/utils/notice_utils.dart';
  ...
  Future<void> check() async {
    ...
    try {
      ...
      try {
        ...
        Log.i('WmimoUtils parseNotice exception ${err.toString()}');
        _duration = const Duration(hours: 1);
        save();
        return;
      }
      if (gnotice == null) {
        Log.i('WmimoUtils parseNotice exception gnotice is null');
        _duration = const Duration(hours: 1);
        save();
        return;
      }
