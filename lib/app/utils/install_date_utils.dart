import 'dart:io';
import 'package:wmimo/app/utils/app_registry_utils.dart';
import 'package:wmimo/app/utils/secure_storage_utils.dart';
...
abstract final class InstallDateUtils {
  ...
  static String _getDeviceIdKey() {
    if (Platform.isIOS) {
      return 'WmimoInstallDateIOS';
    } else if (Platform.isMacOS) {
      return 'WmimoInstallDateMacOS';
    }

    return 'WmimoInstallDate';
  }
