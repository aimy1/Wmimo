...
class InAppWebViewScreen extends StatefulWidget {
  ...
  static String _defaultUserAgentWithWmimo = "";
  static Future<void> _init() async {
    ...
    if (Platform.isAndroid || Platform.isIOS || Platform.isMacOS) {
      ...
      _defaultUserAgentWithWmimo =
          "$_defaultUserAgent Wmimo/${AppUtils.getBuildinVersion()}";
    } else {
      ...
      _defaultUserAgentWithWmimo =
          "$userAgent Wmimo/${AppUtils.getBuildinVersion()}";
    }
    _inited = true;
  }
  ...
  final bool appendWmimoToUseragent;
  final String jsObjectName;
  final String appendMoreWmimoToUseragent;
  ...
  InAppWebViewScreen({
    ...
    this.injectJs = "",
    this.appendWmimoToUseragent = false,
    this.appendMoreWmimoToUseragent = "",
    this.jsObjectName = "wmimo",
...
class _InAppWebViewScreenState extends State<InAppWebViewScreen> {
  ...
  void initState() {
    ...
    String useragent = InAppWebViewScreen._defaultUserAgentWithWmimo;
    if (widget.appendMoreWmimoToUseragent.isNotEmpty) {
      useragent =
          "${InAppWebViewScreen._defaultUserAgentWithWmimo} ${widget.appendMoreWmimoToUseragent}";
    }
    _settings = InAppWebViewSettings(
      ...
      userAgent: widget.appendWmimoToUseragent
          ? useragent
  ...
  void setJavaScriptHandler() {
    ...
    /*
    window.wmimo.callHandler('close').then(function(result) {
        console.log(result);
        return result;
    }).catch(function() {
    ...
    window.wmimo.callHandler('version').then(function(result) {
        console.log(result);
        return result;
    }).catch(function() {
        var event = new Event('error');
    ...
    window.wmimo.callHandler('openUrl', 'wmimo://install-config?url=...').then(function(result) {
        console.log(result);
        return result;
    }).catch(function() {
        var event = new Event('error');
     ...
     window.wmimo.callHandler('openUrl', 'wmimo://disconnect').then(function(result) {
        console.log(result);
        return result;
    }).catch(function() {
        var event = new Event('error');
