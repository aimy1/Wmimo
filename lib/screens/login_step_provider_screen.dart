...
import 'package:wmimo/screens/inapp_webview_screen.dart'
    show InAppWebViewScreen;
import 'package:wmimo/screens/login_step_account_screen.dart';
import 'package:wmimo/screens/theme_config.dart';
import 'package:wmimo/screens/theme_define.dart';
import 'package:wmimo/screens/webview_isp_helper.dart';
...
class _LoginStepProviderScreenState extends State<LoginStepProviderScreen> {
  ...
  Future<void> _loginByWeb(BoardProviderConfig provider) async {
    ...
    String bindJs = provider.bindJs.isEmpty
        ? "https://tools.wmimo.app/assets/bind.js?v="
        : provider.bindJs;
